            ...
            <div class = 'information'>
                ...
                <div class = 'status'>
                    ...
                    <?php elseif ($status_pilihan == 1):?>
                        <p>Selamat! Anda diterima di pilihan 1 <?php echo $fakultas1;?> &nbsp<?php echo $jurusan1;?> </p>
                    <?php elseif ($status_pilihan == 2):?>
                        <p>Selamat! Anda diterima di pilihan 2 <?php echo $fakultas2;?> &nbsp<?php echo $jurusan2;?></p>
