...
class C_NewAccount extends CI_Controller {
	...
	function authentification() {
		...
		$this->form_validation->set_rules('city', 'Kota', 'required|callback_alpha_dash_space',
	...
	function alpha_dash_space()
	{	
		if (( ! preg_match("/^([-a-z_ ])+$/i", $this->input->post('city'))) ){
		$this->form_validation->set_message('alpha_dash_space','kolom  kota hanya huruf dan spasi');
		return False;
